  ...
  return (
    <div className="h-screen relative overflow-hidden">
      ...
      <div className="fixed w-full z-10 bottom-0 translate-y-full bg-white px-3 py-6">
        ...
        <div className="flex  active:border-2 active:border-black mb-2 rounded-xl w-full p-1 items-center justify-around">
          ...
          <div className=" w-1/2">
            <h4 className="font-medium text-base">ComfyGo <span><i className="ri-user-3-fill">4</i></span></h4>
        ...
        <div className="flex  active:border-2 active:border-black mb-2 rounded-xl w-full p-1 items-center justify-around">
          ...
          <div className=" w-1/2">
            <h4 className="font-medium text-base">Comfy Auto <span><i className="ri-user-3-fill">1</i></span></h4>
            <h5 className="font-medium text-sm">3 min away</h5>
