...
const FinishRide = (props) => {
  return (
    <div>
      ...
      <h3 className="text-xl w-full font-semibold ">Finish this ride</h3>
      ...
      <div className="flex gap-2 justify-between flex-col items-center">
        ...
        <div className="mt-6 w-full">
          <Link
            to="/captain-home"
            className="flex justify-center text-lg w-full mt-2 bg-black text-white font-semibold p-2 rounded-lg"
          >
            Finish Ride
          </Link>
        </div>
